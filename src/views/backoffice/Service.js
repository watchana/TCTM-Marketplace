...
const Service = () => {
  ...
  return (
    <StyledDataGrid
      autoHeight
      rows={Userlist?.map(val => ({ ...val, id: val.ser_id.toString() })) || []} // เพิ่มคุณสมบัติ id ในแต่ละแถว
      ...
      columns={[
        ...
        { field: 'ser_name', headerName: 'Name', width: 150 },
          ...
          renderCell: params => (
            <div>
              ...
              <Button
                ...
                // onClick={() => {
                //   router.push(`/member/modal/?post_id=${params.row.post_id}`)
                // }}
              >
                Details
              </Button>

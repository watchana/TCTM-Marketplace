...
const Addbillbord = ({ imageChange, setImageChange, onUploadImagesChange }) => {
                  ...
                  <Grid item xs={12} lg={10}>
                    ...
                    >
                      {uploadImages.length > 0 ? (
                        ...
                        <Typography variant='body1'>Upload 1920*632 Pixels image</Typography>
                      )}
                    </Card>
                  </Grid>
                </Grid>

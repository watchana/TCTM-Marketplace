    ...
    <Grid container id='form-to-image' sx={{ px: { xs: 12, sm: 12, md: 12, lg: 24 } }}>
      <Paper elevation={3} style={{ padding: '60px' }}>
        ...
        <Box sx={{ width: '100%', marginBottom: 4 }}>
          <Divider sx={{ marginY: 6, color: '#3A46A7' }}>Please Upload Your Resume If You Have</Divider>
          <input type='file' accept='.pdf' style={{ display: 'none' }} id='upload-image' onChange={handleFileSelect} />

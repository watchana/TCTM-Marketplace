      ...
      <Grid container>
        ...
        <Grid container spacing={2} ml={10}>
          <Grid item xs={2} mt={5}>
            ...
            <RadioGroup row aria-labelledby='demo-row-radio-buttons-group-label' name='typing_yn'>
              <FormControlLabel
                value='yes'
          ...
          <Grid item xs={2} mt={5}>
            ...
            <TextField name='typing_thaiwords' placeholder='Thai Words/Min.' fullWidth />
          </Grid>
          <Grid item xs={2.3} mt={5} mr={130}>
            <Typography fontSize={20}>English Words/Min.</Typography>
            <TextField name='typing_engwords' placeholder='English Words/Min.' fullWidth />
          </Grid>
          {/* -----------------computer--------------- */}
          <Grid item xs={2} mt={5}>
            <Typography fontSize={20}>computer</Typography>
            <RadioGroup row aria-labelledby='demo-row-radio-buttons-group-label' name='com_yn'>
              <FormControlLabel
                value='yes'
                control={<Radio sx={{ '& .MuiSvgIcon-root': { fontSize: 35 } }} />}
                label='Yes'
          ...
          <Grid item xs={6} mt={5} mr={90}>
            ...
            <TextField name='mention_com' placeholder='Please Mention' fullWidth />
          </Grid>
          {/* -----------------Driving--------------- */}
          <Grid item xs={2} mt={5}>
            <Typography fontSize={20}>Driving</Typography>
            <RadioGroup row aria-labelledby='demo-row-radio-buttons-group-label' name='driving_yn'>
              <FormControlLabel
                value='yes'
                control={<Radio sx={{ '& .MuiSvgIcon-root': { fontSize: 35 } }} />}
                label='Yes'
          ...
          <Grid item xs={6} mt={5}>
            ...
            <TextField name='dlicense_no' placeholder='Driving License No.' fullWidth />
          </Grid>
          {/* -----------------Office Machine--------------- */}
          <Grid item xs={8} mt={5}>
            <Typography fontSize={20}>Office Machine</Typography>
            <TextField name='office_machine' placeholder='Office Machine' fullWidth />
          </Grid>
          {/* -----------------Special knowledge Please Mention--------------- */}
          <Grid item xs={8} mt={5}>
            <Typography fontSize={20}>Special knowledge Please Mention</Typography>
            <TextField name='knowledge_mention' placeholder='Special knowledge Please Mention' fullWidth />
          </Grid>
        </Grid>
      </Grid>
    </form>

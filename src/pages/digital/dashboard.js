...
const DashboardDigital = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_API}DIGITAL.dashboard.get_data_in_dashboard`)
...
export default DashboardDigital
